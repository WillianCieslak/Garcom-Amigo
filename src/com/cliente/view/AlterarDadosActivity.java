...
public class AlterarDadosActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editTextNomeCompleto.setText(LogadoSing.getInst().getCliente()
				.getNmPessoa());
		editTextCpf.setText(LogadoSing.getInst().getCliente().getNrCpf());
		editTextDataNascimento.setText(LogadoSing.getInst().getCliente()
				.getDtNascimento());
		editTextCelular.setText(LogadoSing.getInst().getCliente()
				.getNrCelular());
		editTextEmail.setText(LogadoSing.getInst().getCliente().getDsEmail());
		editTextSenha.setText(LogadoSing.getInst().getCliente().getDsSenha());
	...
	public void onClickContinuar(View view) {
		...
		try {
			if(senha.equals(confirmarSenha)){
				...
				cliente2 = CadastroController.salvar(cliente);
				Toast.makeText(getApplicationContext(), "Dados Alterados!",
						Toast.LENGTH_LONG);
				if (cliente2 != null) {
